...
export interface Person { id: string; name: string; phone: string; email?: string; image?: string; tier?: string; phoneVerificationTime?: number; phoneVerificationEnabled?: boolean; activationDestination?: "name" | "routes"; verification: VerificationStatus; role: "member" | "admin" | "compliance"; joinedAt: number; suspended?: boolean; suspensionReason?: string; mustChangePassword?: boolean; identityNote?: string; identitySubmittedAt?: number; documentType?: DocumentType; identityEvidenceIds?: string[]; rating?: number; reviewCount?: number; successfulDeliveries?: number; walletBalanceNaira?: number; bvn?: string; residenceState?: string; residenceLga?: string; residenceAddress?: string; streetPhotoUrl?: string; housePhotoUrl?: string; }
